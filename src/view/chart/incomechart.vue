<template>
    <div id="incomechart">
        <mt-header fixed title="粒粒记账">
            ...
            <i slot="right" class="fa fa-sort" aria-hidden="true" @click="$router.push({path: '/expenditurechart'})">&nbsp;&nbsp;收入</i>
        </mt-header>
        <div class="content">
        ...
        <div class="total-pingjun">
            <div class="total">总收入: {{ this.total }}</div>
...
export default {
    ...
    methods: {
        ...
        FormatBarData(barData) {
            ...
            if (barData != null) {
                barData.forEach((val) => {
                    this.billType.income.forEach((val2) => {
